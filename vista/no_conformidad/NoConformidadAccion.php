...
<script>
    Phx.vista.NoConformidadAccion = {
        ...
        tabsouth:[
            {
                url:'../../../sis_auditoria/vista/accion_propuesta/AccionesPropuestaPendientes.php',
                title:'Acciones',
                height:'50%',
                cls:'AccionesPropuestaPendientes'
            }
        ],
    };

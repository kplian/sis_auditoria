...
/**
 *@package pXP
 *@file AuditorioAportunidadAcepRech.php
...
?>
<script>
    Phx.vista.AuditorioAportunidadAcepRech = {
        bedit:false,
        bnew:false,
        bsave:false,
        bdel:false,
        ...
        title:'Auditoria',
        nombreVista: 'AuditorioAportunidadAcepRech',
        constructor: function(config) {
            Phx.vista.AuditorioAportunidadAcepRech.superclass.constructor.call(this,config);
        ...
        preparaMenu:function(n){
            ...
            const tb =this.tbar;
            Phx.vista.AuditorioAportunidadAcepRech.superclass.preparaMenu.call(this,n);
        ...
        liberaMenu:function(){
            const data = this.getSelectedData();
            const tb = Phx.vista.AuditorioAportunidadAcepRech.superclass.liberaMenu.call(this);
            if(tb){
        ...
        sigEstado:function(){
            ...
            if(confirm('¿Proponer Acciones No Conformindades ')){
                Ext.Ajax.request({

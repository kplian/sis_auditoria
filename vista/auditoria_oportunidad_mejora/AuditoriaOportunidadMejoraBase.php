...
/**
 *@package pXP
 *@file AuditoriaOportunidadMejoraBase.php
 *@author MMV
 *@date 21/04/2020
...
?>
<script>
    Phx.vista.AuditoriaOportunidadMejoraBase = Ext.extend(Phx.gridInterfaz,{
            constructor:function(config){
                this.maestro=config.maestro;
                Phx.vista.AuditoriaOportunidadMejoraBase.superclass.constructor.call(this,config);
                this.init();
            },
            Atributos:[
                {

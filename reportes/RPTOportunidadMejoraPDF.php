<?php
class RPTOportunidadMejoraPDF extends  ReportePDF
{
    function Header(){
    ...
    function reporteRequerimiento() {
        ...
        $this->Cell(33.30, 0, 'Grupo Consultivo', 1, 0, 'C', 0, '', 0);
        ...
        if(count($this->datos) > 0){
            foreach ($this->datos as $Row) {
                ...
                $gconsultivo = $Row['nombre_gconsultivo'];
    ...
    <table cellspacing="0" cellpadding="1" border="1" >
        <tr>
            ...
            <td width="118.4"  align="center">$gconsultivo</td>

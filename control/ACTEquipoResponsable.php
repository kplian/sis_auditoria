...
class ACTEquipoResponsable extends ACTbase
{
    ...
    function listarEquipoResponsable()
    {
        ...
        if ($this->objParam->getParametro('desc_funcionario1') != '') {
            $this->objParam->addFiltro("((vfc.desc_funcionario1::varchar ILIKE ''%" . $this->objParam->getParametro('desc_funcionario1') . "%'') or
                                    to_tsvector(vfc.desc_funcionario1::varchar) @@ plainto_tsquery(''spanish'', ''" . $this->objParam->getParametro('desc_funcionario1') . "''))");
        }

create or replace function ssom.ft_proceso_ime(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying) returns character varying
    language plpgsql
as
$$
/**************************************************************************
    ...
    ***********************************/
    ...
    if (p_transaccion = 'SSOM_PCS_INS') then
        ...
        begin
            ...
            insert into ssom.tproceso(proceso,
                                      descrip_proceso,
                                      acronimo,
                                      estado_reg,
                                      id_responsable,
            ...
            v_resp = pxp.f_agrega_clave(v_resp, 'mensaje',
                                        'Proceso Auditoria almacenado(a) con exito (id_proceso' || v_id_proceso || ')');

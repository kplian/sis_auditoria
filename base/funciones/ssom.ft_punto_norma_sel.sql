create or replace function ssom.ft_punto_norma_sel(p_administrador integer, p_id_usuario integer, p_tabla character varying,
    ...
    ***********************************/
    ...
    if (p_transaccion = 'SSOM_PTONOR_SEL') then
        ...
        begin
            ...
            v_consulta := v_consulta || ' order by string_to_array(ptonor.codigo_pn, ''.'')::int[], ' ||
                          v_parametros.ordenacion || ' ' || v_parametros.dir_ordenacion || ' limit ' ||

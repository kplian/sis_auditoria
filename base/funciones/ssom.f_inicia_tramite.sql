CREATE OR REPLACE FUNCTION ssom.f_inicia_tramite (
...
BEGIN
     ...
     v_nombre_funcion = 'wf.f_inicia_tramite';
         ...
         select    tp.id_proceso_macro, tp.inicio, tp.id_tipo_proceso , tp.codigo
         into      v_id_proceso_macro, v_inicio, v_id_tipo_proceso ,v_codigo_proceso

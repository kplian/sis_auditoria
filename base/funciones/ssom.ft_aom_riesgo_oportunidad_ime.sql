create or replace function ssom.ft_aom_riesgo_oportunidad_ime(p_administrador integer, p_id_usuario integer, p_tabla character varying, p_transaccion character varying) returns character varying
    language plpgsql
as
$$
/**************************************************************************
...
BEGIN
    ...
    ***********************************/
    ...
    if (p_transaccion = 'SSOM_AURO_INS') then
        ...
        begin
            ...
            insert into ssom.taom_riesgo_oportunidad(estado_reg,
                                                     id_impacto,
                                                     id_probabilidad,
                                                     id_tipo_ro,
                                                     id_ro,
            ...
            values ('activo',
                    ...
                    null,
                    null,
                    v_parametros.acciones_ro)
            RETURNING id_aom_ro into v_id_aom_ro;

            --Definicion de la respuesta
            v_resp = pxp.f_agrega_clave(v_resp, 'mensaje',
                                        'Auditoria Riesgo Oportunidad almacenado(a) con exito (id_aom_ro' ||
                                        v_id_aom_ro || ')');
    ...
    ***********************************/
        ...
        begin
            ...
            update ssom.taom_riesgo_oportunidad
            set id_impacto      = v_parametros.id_impacto,
                ...
                acciones_ro     = v_parametros.acciones_ro
    ...
    ***********************************/
        ...
        begin
            ...
            delete
            from ssom.taom_riesgo_oportunidad
            where id_aom_ro = v_parametros.id_aom_ro;

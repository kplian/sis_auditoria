CREATE OR REPLACE FUNCTION ssom.ft_cronograma_sel (
...
ALTER FUNCTION ssom.ft_cronograma_sel (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;
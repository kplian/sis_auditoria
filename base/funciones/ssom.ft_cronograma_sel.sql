    ...
    ***********************************/
    ...
    if (p_transaccion = 'SSOM_CRONOG_SEL') then
        ...
        begin
            ...
            v_consulta := 'select  cronog.id_cronograma,
                                   ...
                                   atv.actividad,
                                   (select pxp.list(initcap(coalesce(fu.desc_funcionario1,ee.exp_tec_externo)))
                                    from ssom.tcronograma_equipo_responsable cc
                                             inner join ssom.tequipo_responsable ee on ee.id_equipo_responsable = cc.id_equipo_responsable
                                             left join orga.vfuncionario fu on fu.id_funcionario = ee.id_funcionario

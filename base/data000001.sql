...
select wf.f_import_ttipo_proceso ('insert','AUDSE',NULL,NULL,'AUD','Seguimiento de Auditoria','','','si','','','','AUDSE',NULL);
...
select wf.f_import_testructura_estado ('insert','borrador','programada','AUDSE',1,'');

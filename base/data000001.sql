...
select wf.f_import_ttipo_estado ('insert','cerrado','AUDSE','Cerrado','no','no','si','ninguno','','ninguno','','','no','no',NULL,'<font color="99CC00" size="5"><font size="4">{TIPO_PROCESO}</font></font><br><br><b>&nbsp;</b>Tramite:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <b>{NUM_TRAMITE}</b><br><b>&nbsp;</b>Usuario :<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {USUARIO_PREVIO} </b>en estado<b>&nbsp; {ESTADO_ANTERIOR}<br></b>&nbsp;<b>Responsable:&nbsp;&nbsp; &nbsp;&nbsp; </b><b>{FUNCIONARIO_PREVIO}&nbsp; {DEPTO_PREVIO}<br>&nbsp;</b>Estado Actual<b>: &nbsp; &nbsp;&nbsp; {ESTADO_ACTUAL}</b><br><br><br>&nbsp;{OBS} <br>','Aviso WF ,  {PROCESO_MACRO}  ({NUM_TRAMITE})','','si','','','','','','','',NULL'',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL);
select wf.f_import_ttipo_documento ('delete','IN','AUDSE',NULL,NULL,NULL,NULL,NULL,NULL);
select wf.f_import_ttipo_documento ('delete','AUD','AUDSE',NULL,NULL,NULL,NULL,NULL,NULL);
select wf.f_import_ttipo_documento ('insert','AREV','AUNC','Archivos Evidencia','Archivos Evidencia','','escaneado',1.00,'{}');
select wf.f_import_ttipo_documento ('delete','INOC','AUNC',NULL,NULL,NULL,NULL,NULL,NULL);
...
select wf.f_import_testructura_estado ('delete','vbplanificacion','informe','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','informe','vbinforme','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbinforme','aceptado_responsable','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','borrador','programada','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','programada','planificacion','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','planificacion','vbplanificacion','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','borrador','informe','AUDSE',NULL,NULL);
select wf.f_import_testructura_estado ('delete','propuesta','vbpropuesta_responsable','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbpropuesta_responsable','vbpropuesta_auditor','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbpropuesta_auditor','implementada','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','implementada','vbimplementada_responsable','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbimplementada_responsable','vbimplementada_auditor','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbimplementada_auditor','finalizado','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbnoconformidad','correccion','AUNC',NULL,NULL);
select wf.f_import_testructura_estado ('delete','correccion','finalizado','AUNC',NULL,NULL);
select wf.f_import_testructura_estado ('delete','vbpropuesta_responsable','vbpropuesta_auditor','ACCP',NULL,NULL);
select wf.f_import_testructura_estado ('delete','propuesta','vbnoconformidad','AUNC',NULL,NULL);
...
select wf.f_import_testructura_estado ('delete','ejecutada','notificar','AUDSE',NULL,NULL);
